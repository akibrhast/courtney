...
import (
	...
	"github.com/akibrhast/courtney/tester/logger"
	"github.com/akibrhast/courtney/tester/merge"
...
func (t *Tester) processDir(dir string, pkgPath string) error {
	...
	if err != nil {
		// TODO: Remove when https://github.com/akibrhast/courtney/issues/4 is fixed
		// notest
		if t.setup.Verbose {
